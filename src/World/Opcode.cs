namespace Classic.World
{
    ...
    // https://github.com/cmangos/mangos-classic/blob/master/src/game/Server/Opcodes.h
    // https://github.com/cmangos/mangos-tbc/blob/master/src/game/Server/Opcodes.h
    public enum Opcode
    {
        ...
        CMSG_WHOIS = 0x064,
        SMSG_WHOIS = 0x065,
        CMSG_CONTACT_LIST = 0x066, // was CMSG_FRIEND_LIST 
        SMSG_CONTACT_LIST = 0x067, // was SMSG_FRIEND_LIST
        SMSG_FRIEND_STATUS = 0x068,
        CMSG_ADD_FRIEND = 0x069,
        CMSG_DEL_FRIEND = 0x06A,
        CMSG_SET_CONTACT_NOTES = 0x06B, // was SMSG_IGNORE_LIST 
        ...
        SMSG_MEETINGSTONE_LEAVE = 0x293, // was CMSG_MEETINGSTONE_LEAVE
