...
class OPCODE(Enum):
    ...
    CMSG_GM_NUKE                                         = 0x1FA    # notusedinclient
    MSG_RANDOM_ROLL                                      = 0x1FB
    SMSG_ENVIRONMENTALDAMAGELOG                          = 0x1FC
    CMSG_RWHOIS_OBSOLETE                                 = 0x1FD    # notusedinclient
    SMSG_RWHOIS                                          = 0x1FE
    ...
    CMSG_SERVER_BROADCAST                                = 0x2B2    # notusedinclient
    CMSG_SELF_RES                                        = 0x2B3
    SMSG_FEIGN_DEATH_RESISTED                            = 0x2B4
    CMSG_RUN_SCRIPT                                      = 0x2B5    # notusedinclient
    SMSG_SCRIPT_MESSAGE                                  = 0x2B6    # notusedinclient
    ...
    CMSG_MOVE_START_SWIM_CHEAT                           = 0x2D8    # notusedinclient
    CMSG_MOVE_STOP_SWIM_CHEAT                            = 0x2D9    # notusedinclient
    ...
    CMSG_GM_UNTEACH                                      = 0x2E5    # notusedinclient
    ...
    SMSG_MINIGAME_MOVE_FAILED                            = 0x2F9    # notusedinclient
    ...
    SMSG_GAMETIMEBIAS_SET                                = 0x314    # notusedinclient
    ...
    CMSG_LUA_USAGE                                       = 0x323    # notusedinclient
    ...
    SMSG_CHAT_PLAYER_AMBIGUOUS                           = 0x32D    # notusedinclient
    MSG_DELAY_GHOST_TELEPORT                             = 0x32E    # notusedinclient
    ...
    CMSG_LOTTERY_QUERY_OBSOLETE                          = 0x334    # notusedinclient
    SMSG_LOTTERY_QUERY_RESULT_OBSOLETE                   = 0x335    # notusedinclient
    CMSG_BUY_LOTTERY_TICKET_OBSOLETE                     = 0x336    # notusedinclient
    SMSG_LOTTERY_RESULT_OBSOLETE                         = 0x337    # notusedinclient
    SMSG_CHARACTER_PROFILE                               = 0x338    # notusedinclient
    SMSG_CHARACTER_PROFILE_REALM_CONNECTED               = 0x339    # notusedinclient
    SMSG_DEFENSE_MESSAGE                                 = 0x33A
    SMSG_INSTANCE_DIFFICULTY                             = 0x33B
    MSG_GM_RESETINSTANCELIMIT                            = 0x33C    # notusedinclient
    SMSG_MOTD                                            = 0x33D
    SMSG_MOVE_SET_FLIGHT_OBSOLETE                        = 0x33E    # notusedinclient
    SMSG_MOVE_UNSET_FLIGHT_OBSOLETE                      = 0x33F    # notusedinclient
    CMSG_MOVE_FLIGHT_ACK_OBSOLETE                        = 0x340    # notusedinclient
    ...
    CMSG_FORCE_SAY_CHEAT                                 = 0x47E    # notusedinclient
    ...
    SMSG_ADD_RUNE_POWER                                  = 0x488    # uint32amounth
    ...
    CMSG_FLOOD_GRACE_CHEAT                               = 0x497    # notusedinclient
    SMSG_SERVER_FIRST_ACHIEVEMENT                        = 0x498
    SMSG_PET_LEARNED_SPELL                               = 0x499    # uint16spellid'Yourpetlearnedspell:%s'
    SMSG_PET_UNLEARNED_SPELL                             = 0x49A    # uint16spellid'Yourpetunlearned%s'
    CMSG_CHANGE_SEATS_ON_CONTROLLED_VEHICLE              = 0x49B    # notusedinclient
    CMSG_HEARTH_AND_RESURRECT                            = 0x49C    # lua:HearthAndResurrectFromAreaempty
    SMSG_CONTROL_VEHICLE                                 = 0x49D    # empty
    SMSG_CRITERIA_DELETED                                = 0x49E    # uint32
    SMSG_ACHIEVEMENT_DELETED                             = 0x49F    # uint32
    CMSG_SERVER_INFO_QUERY                               = 0x4A0    # notusedinclient
    SMSG_SERVER_INFO_RESPONSE                            = 0x4A1    # notusedinclient
    CMSG_CHECK_LOGIN_CRITERIA                            = 0x4A2    # notusedinclient
    SMSG_SERVER_BUCK_DATA_START                          = 0x4A3    # notusedinclient
    CMSG_QUERY_VEHICLE_STATUS                            = 0x4A4    # notusedinclient
